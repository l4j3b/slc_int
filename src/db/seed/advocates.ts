...
const randomSpecialty = () => {
  const numberOfSpecialties = specialties.length;
  const random1 = Math.floor(Math.random() * numberOfSpecialties);
  const random2 =
    Math.floor(Math.random() * (numberOfSpecialties - random1)) + random1;
